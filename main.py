...
# Input GitHub URL
st.header("Fetch Data from GitHub")
file_url = st.text_input("https://github.com/Rsaltos7/AERONET_Streamlit/blob/main/20230101_20241231_Turlock_CA_USA_part1.lev15", "https://github.com/Rsaltos7/AERONET_Streamlit/blob/main/20230101_20241231_Turlock_CA_USA_part2.lev15")
...
if file_url:
    try:
        ...
        if st.button("Submit"):
            ...
            plt.plot(df.loc[StartDateTime:EndDateTime, "AOD_380nm"].resample(SampleRate).mean(), 
                     color=wavelength_colors["380 nm"], label="380 nm")
            plt.plot(df.loc[StartDateTime:EndDateTime, "AOD_500nm"].resample(SampleRate).mean(), 
                     color=wavelength_colors["500 nm"], label="500 nm")
            plt.plot(df.loc[StartDateTime:EndDateTime, "AOD_870nm"].resample(SampleRate).mean(), 
                     color=wavelength_colors["870 nm"], label="870 nm")
