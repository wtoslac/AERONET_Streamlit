...
if file is not None:
    ...
    plt.gca().xaxis.set_major_locator(mdates.DayLocator(interval=1, tz=pacific_tz))
    plt.gca().xaxis.set_minor_locator(mdates.HourLocator(interval=12, tz=pacific_tz))
