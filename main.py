...
# Set the start and end date inputs for the data range
StartDate = '2023-07-01 00:00:00'
EndDate = '2023-07-05 23:59:59'

# Set wind sample rate (could be hourly or any desired frequency)
windSampleRate = '1h'
...
# Extract the relevant wind data and filter valid observations (WND == '5')
WNDdf = Wdf.loc[StartDate:EndDate, 'WND'].str.split(pat=',', expand=True)
WNDdf = WNDdf.loc[WNDdf[4] == '5']  # Only valid observations

# Convert polar to Cartesian coordinates for wind vectors (magnitude and direction)
Xdata, Ydata = [], []
...
# Resample data and create the quiver plot
ax.quiver(
